...
import { DmTrinhdo } from '../models/danh_muc';
import { getRoute } from '@env';

@Injectable({
  providedIn: 'root'
})
export class DmTrinhdoService {

  private readonly api = getRoute('danhmuc-trinhdo/');
  ...
  list(ma_id: number, filter?: { search: string }): Observable<DmTrinhdo[]> {
