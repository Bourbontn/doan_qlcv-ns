...
import { DmTongiao } from '../models/danh_muc';
...
export class DmTongiaoService {

  private readonly api = getRoute('danhmuc-tongiao/');
  ...
  constructor(    private http: HttpClient,
    ...
    list(ma_id: number, filter?: { search: string }): Observable<DmTongiao[]> {
