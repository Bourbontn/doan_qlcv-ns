...
import { DmTrinhdoChinhtri } from './../models/danh_muc';
import { Injectable } from '@angular/core';

@Injectable({
  providedIn: 'root'
})
export class DmTrinhdoChinhtriService {

  private readonly api = getRoute('danhmuc-trinhdo-chinhtri/');
  ...
  constructor(    private http: HttpClient,
    ...
    list(ma_id: number, filter?: { search: string }): Observable<DmTrinhdoChinhtri[]> {
